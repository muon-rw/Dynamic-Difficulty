...
public class DimensionTagLevelingSettingsReloader extends SimpleJsonResourceReloadListener implements IdentifiableResourceReloadListener {
  ...
  public DimensionTagLevelingSettingsReloader() {
    super(GSON, "leveling_settings/dimension_tags");
  }
  ...
  protected void apply(
    ...
    Map<ResourceLocation, DimensionLevelingSettings> tagSettings = new HashMap<>();
    ...
    DimensionsLevelingSettingsReloader.loadTagSettings(tagSettings);
  }
}
