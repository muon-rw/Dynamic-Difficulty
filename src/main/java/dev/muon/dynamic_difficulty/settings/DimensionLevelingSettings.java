 ...
 * Created by resolving RawSettings with config defaults.
 */
public record DimensionLevelingSettings(
  ...
  public int seaLevel() {
    return seaLevel; // Return the stored value
  }
  ...
  public static DimensionLevelingSettings createDefault() {
    return new DimensionLevelingSettings(
        ...
        0.0f, // levelsPerHeight - not in config, default to 0
