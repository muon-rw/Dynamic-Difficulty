...
public record BiomeBonusSettings(int levelBonus, boolean bypassesCap) {
  public static final Codec<BiomeBonusSettings> CODEC = RecordCodecBuilder.create(instance -> instance.group(
