...
public class StructureLevelingSettingsReloaderNeoForge extends ContextAwareReloadListener {
    private static final Gson GSON = new Gson();
    private static final String DIRECTORY = "leveling_settings/structures";
    ...
    public String getName() {
        return "Structure Leveling Settings";
    }
