...
public class BiomeTagLevelingSettingsReloaderNeoForge extends ContextAwareReloadListener {
    private static final Gson GSON = new Gson();
    private static final String DIRECTORY = "leveling_settings/biome_tags";
    ...
    public String getName() {
        return "Biome Tag Leveling Settings";
    }

    protected void apply(Map<Identifier, JsonElement> prepared) {
        Map<Identifier, BiomeBonusSettings> settings = new HashMap<>();
