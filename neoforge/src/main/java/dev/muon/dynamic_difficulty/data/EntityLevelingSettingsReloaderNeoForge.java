...
public class EntityLevelingSettingsReloaderNeoForge extends ContextAwareReloadListener {
    private static final Gson GSON = new Gson();
    private static final String DIRECTORY = "leveling_settings/entities";
    ...
    public String getName() {
        return "Entity Leveling Settings";
    }
