...
public class DimensionsLevelingSettingsReloaderNeoForge extends ContextAwareReloadListener {
    ...
    private static final String DIRECTORY = "leveling_settings/dimensions";
    ...
    public String getName() {
        return "Dimension Leveling Settings";
    }

    protected void apply(Map<Identifier, JsonElement> prepared) {
        Map<Identifier, DimensionLevelingSettings> settings = new HashMap<>();
