...
public class BiomeTagLevelingSettingsReloaderFabric extends SimpleJsonResourceReloadListener implements IdentifiableResourceReloadListener {
    ...
    public BiomeTagLevelingSettingsReloaderFabric() {
        super(GSON, "leveling_settings/biome_tags");
    }
    ...
    protected void apply(Map<ResourceLocation, JsonElement> prepared, @NotNull ResourceManager resourceManager, @NotNull ProfilerFiller profiler) {
        ...
        BiomeLevelingSettingsReloader.loadTagSettings(settings);
    }
}
